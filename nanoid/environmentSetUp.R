...
library(future)
mc.cores = round(as.numeric(readLines("/sys/fs/cgroup/cpu/cpu.shares"))/1024) #availableCores() To be improved, I should pass this argument to the functions exploiting the nextflow parameters.
...
bioconductorPackages <- c("rhdf5","GenomicRanges","GenomeInfoDb","SummarizedExperiment","GenomicAlignments","Rsamtools","Biobase","Biostrings","XVector","IRanges","S4Vectors","BiocGenerics","zlibbioc","BiocParallel","rtracklayer")
